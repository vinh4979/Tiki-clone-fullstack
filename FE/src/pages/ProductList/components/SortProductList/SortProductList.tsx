        ...
        <div className='flex flex-wrap items-center gap-2'>
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-blue-500 text-white hover:bg-blue-600': isActiveSortBy(sortBy.view),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-blue-500 text-white hover:bg-blue-600': isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames('h-8 px-4 text-center text-sm capitalize ', {
              'bg-blue-500 text-white hover:bg-blue-600': isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames('h-8  px-4 text-left text-sm capitalize  outline-none ', {
              'bg-blue-500 text-white hover:bg-blue-600': isActiveSortBy(sortBy.price),
